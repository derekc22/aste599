...
def dmpc_centralized(Z, d_min, dt, N, nx, nu, U_lim, x0_val, xf_val, f, f_np, sigma, obs, Q, R, H, term, dyn):
    ...
    plot_t(t_max, N, Z, x_cl, u_cl, J_cl_avg, f"{dyn}_centralized")
    plot_xyz(Z, x_cl, x0_val, xf_val, J_cl_avg, obs, f"{dyn}_centralized")