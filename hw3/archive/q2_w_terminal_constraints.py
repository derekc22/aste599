...
def q2b():
    ...
    # if no disturbances are present, we can enforce a hard terminal constraint
...
def q2e():
    ...
    # under disturbance, a hard terminal constraint may make the problem infeasible; thus, remove it for the stochastic case
    # opti.subject_to(X[:, N] == xf) # terminal constraint, xf
